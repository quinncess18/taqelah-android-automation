...
- **Upcoming:** §15 Checkout (TC-K01–K04) → §16 End-to-End regression (TC-E01). Real-device cloud for full Location coverage (mock-location injection or LambdaTest/Firebase Test Lab) — emulator GPS is unreliable across AVDs.
